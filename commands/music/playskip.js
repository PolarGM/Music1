    ...
    run: async (client, message, args, prefix) => {
        ...
        try {
            ...
            if(!playlist) {
                ...
                return m.edit(`**Now playing and skipping to: __${song.title}__** - \`${song.durationFormatted}\``).catch(() => null);
            } 
            /* FOR PLAYLIST REQUEST */
                ...
                oldConnection.state.subscription.player.stop();
                // edit the loading message                    
                return m.edit(`<968552025723928647> **Now playing and skipping to: __${song.title}__** - \`${song.durationFormatted}\`\n> **Added \`${playlist.videos.length - 1} Songs\` from the Playlist:**\n> __**${playlist.title}**__`).catch(() => null);
            }
